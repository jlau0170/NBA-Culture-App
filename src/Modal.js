  ...
  render() {
    ...
    return (
      <div className = "modal">
        ...
        <StatCard pts = {playerData.pts} ast = {playerData.ast} reb = {playerData.reb} stl = {playerData.stl} blk = {playerData.blk} fg_pct = {playerData.fg_pct} fg3_pct = {playerData.fg3_pct} />
