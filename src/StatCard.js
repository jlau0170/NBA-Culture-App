...
const StatCard = ({pts,ast,reb,stl,blk,fg_pct,fg3_pct}) => {
  return(
    <div className = "statscontainer">
      ...
      <div className = "3PtFieldGoalCol">
            <h1 className = "StatTitle"> 3-pt Field Goal </h1>
            <p className = "StatAverage">{(Math.round(fg3_pct * 100)) + "%"} </p>
      </div>
